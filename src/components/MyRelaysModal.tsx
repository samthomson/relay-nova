      ...
      <DialogContent className="max-w-4xl max-h-[80vh] bg-gray-900/95 backdrop-blur-md border border-white/10">
        ...
        <Tabs defaultValue="my-relays" className="w-full">
          <TabsList className="grid w-full grid-cols-2 bg-white/5 border border-white/10">
            <TabsTrigger value="my-relays" className="data-[state=active]:bg-white/10 data-[state=active]:text-white data-[state=inactive]:text-gray-300">
              Relays ({relays?.length || 0})
            </TabsTrigger>
            <TabsTrigger value="all-relays" className="data-[state=active]:bg-white/10 data-[state=active]:text-white data-[state=inactive]:text-gray-300">
              All Relays ({allRelays?.length || 0})
            </TabsTrigger>
          </TabsList>

          {/* My Relays Tab */}
          <TabsContent value="my-relays" className="mt-4 space-y-4">
            ...
            {isAnyOperationPending ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-300 mb-2">No relays configured</p>
